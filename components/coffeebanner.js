...
const Coffeebanner = ({index, coffee}) => {
    ...
    const month = months[new Date(coffee.purchase_date).getMonth()]
    const year = new Date(coffee.purchase_date).getFullYear()
    ...
    return (
        <div className={`p-16 bg-opacity-30 bg-${coffee.bg_color}`}>
            <div
                className={`mx-auto flex flex-col ${isOdd ? "md:flex-row-reverse" : "md:flex-row"} justify-between max-w-6xl`}>
                <div className="flex items-center">
                    <div>
                        <p className="text-sm text-gray-700">{month}, {year}</p>
                        ...
                        <p className="text-sm text-gray-700">{coffee.city}, {coffee.state}, {coffee.country}</p>
                        <br/>
                        ...
                        <div className="max-w-xs min-w-xs">
                            ...
                            <div
                                className="flex justify-between text-xs text-gray-700 uppercase overflow-hidden">
                                <text>light</text>
                                <text>dark</text>
                            </div>
                        </div>
