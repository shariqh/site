...
const Layout = ({children, name}) => (
    <div className="bg-gray-800">
        <div className="flex flex-col min-h-screen max-w-screen-lg mx-auto">
            ...
            <div className="mx-auto flex-grow space-y-12">
                {children}
            </div>
            <footer className="pb-4 mt-16 mx-auto flex flex-row space-x-16 max-w-xl text-gray-400 text-lg">
                ...
                <span className="flex justify-between space-x-6">
                    <a href="https://twitter.com/ShariqHirani">
                    ...
                    <a href="https://github.com/shariqh">
                    ...
                    <a href="https://www.linkedin.com/in/shariqhirani">
