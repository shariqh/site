...
const Index = ({}) => {
    return (
        <Layout name={name}>
            <section className="max-w-lg no-scrollbar">
                ...
                <p className="text-gray-400 text-xl text-justify">
                    ...
                    <Link href="/blog">
                        <a className="text-indigo-300">blog</a>
                    </Link>.
                    <br/>
                    <br/>
                    ...
                    <br/>
                    <br/>
                    The goal is to always learn something new, and maybe I can use it to change the world.
                    ...
                    <Link href="/coffee">
                        <a className="text-indigo-300">whole webpage</a>
                    </Link>&nbsp;to it ☕.
                </p>
            </section>
        </Layout>
